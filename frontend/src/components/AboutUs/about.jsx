  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#0a0f1c] to-[#091621] text-white flex flex-col items-center py-12 px-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl">
        <div className="bg-[#0f1b2d] p-8 rounded-2xl shadow-lg hover:shadow-cyan-500/20 transition">
          <h2 className="text-xl font-semibold text-cyan-300 mb-3">🚴 Bike Garage</h2>
        ...
        <div className="bg-[#0f1b2d] p-8 rounded-2xl shadow-lg hover:shadow-cyan-500/20 transition">
          <h2 className="text-xl font-semibold text-cyan-300 mb-3">🛠 Bike Parts</h2>
          <p className="text-gray-300">
        ...
        <div className="bg-[#0f1b2d] p-8 rounded-2xl shadow-lg hover:shadow-cyan-500/20 transition">
          <h2 className="text-xl font-semibold text-cyan-300 mb-3">💰 Marketplace</h2>
          <p className="text-gray-300">
        ...
        <div className="bg-[#0f1b2d] p-8 rounded-2xl shadow-lg hover:shadow-cyan-500/20 transition">
          <h2 className="text-xl font-semibold text-cyan-300 mb-3">🌐 Community Hub</h2>
          <p className="text-gray-300">
        ...
        <div className="bg-[#0f1b2d] p-8 rounded-2xl shadow-lg hover:shadow-cyan-500/20 transition">
          <h2 className="text-xl font-semibold text-cyan-300 mb-3">📊 Insights</h2>
          <p className="text-gray-300">
        ...
        <div className="bg-[#0f1b2d] p-8 rounded-2xl shadow-lg hover:shadow-cyan-500/20 transition">
          <h2 className="text-xl font-semibold text-cyan-300 mb-3">⚡ Innovation</h2>
          <p className="text-gray-300">
