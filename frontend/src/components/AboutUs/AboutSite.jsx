...
import HeroCon1 from "../../assets/Herocon3.jpg"; // fixed path
...
export default function AboutSite() {
  ...
  return (
    <section
      className="relative min-h-[60vh] flex flex-col items-center justify-center text-center px-6 py-12 text-white bg-cover bg-center"
      style={{
        backgroundImage: `url(${HeroCon1})`,
      }}
    >
      {/* Overlay */}
